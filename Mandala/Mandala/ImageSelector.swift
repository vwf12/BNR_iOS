...
//  Mandala
//
//  Created by FARIT GATIATULLIN on 29.07.2020.
...
class ImageSelector: UIControl {
    ...
    @objc private func imageButtonTapped(_ sender: UIButton) {
        ...
        let selectedAnimator = UIViewPropertyAnimator(
            duration: 0.7, dampingRatio: 0.6, animations: {
    ...
    private func highlightColor(forIndex index: Int) -> UIColor {
        guard index >= 0 && index < hightlightColors.count else {
            return UIColor.blue.withAlphaComponent(0.6)
        }
        
        return hightlightColors[index]
    }
}
